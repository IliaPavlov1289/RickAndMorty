...
class LocationDetailsController: UIViewController {
    ...
    private func createLocationDetailsHeaderView() {
        ...
        self.locationDetailsView.locationDetailsHeaderView.typeLabel.text = location.type
        self.locationDetailsView.locationDetailsHeaderView.nameLabel.text = location.name
        self.locationDetailsView.locationDetailsHeaderView.dimensionLabel.text = location.dimension.uppercased()
    }
